...
<section class="content-header">
    <h2> Role  <small>Permission Management</small> </h2>
    <ol class="breadcrumb">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($roles_data as $row) { ?>
                                        <tr class="role_id_<?php echo $row->id; ?>">
                                            ...
                                            <td>
                                                <span onClick="manage_acl(<?php echo $row->id; ?>)" class="btn btn-default btn-sm"><i class="fa fa fa-cogs"></i> ACL</span>
                                                <span onClick="edit_role(<?php echo $row->id; ?>)" class="btn btn-default btn-sm"> <i class="fa fa-edit"></i> Rename</span>
            ...
            <div class="col-md-4 col-xs-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form id="form" method="post" role="form"  action="admin/users/roles/create">                  
                            <div class="form-group">
                                <label for="roleName">Role Name <sup>*</sup></label>
                                <input type="text" name="role_name" class="form-control" required="required"  data-error="Please enter role name" />
                                <div class="help-block with-errors"></div>
                            </div>
                            <button type="submit" onClick="ajaxFormSubmit('form', 'ajaxRespondID');" class="btn btn-success">Create New Role</button>
                        </form>
                    </div>                
                </div>
            </div>
