                ...
                <div class="col-md-12 no-padding">
                    <div class="panel panel-default no-padding" style="display: table; width: 100%; clear: both;">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#home">General email</a></li>
                            <li><a data-toggle="tab" href="#menu1">System Mail</a></li>
                        </ul>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="menu1" class="tab-pane fade">
                                <div style="padding-left:0;" class="panel-body ">
                                    <div class="mail_sidebar_user">
                                        <div id="ajax_respond_search_system"></div>
                                    </div>                                                                        
                                </div>
                            </div>
                        </div>
...
//                            reload();
                ...
                $( document ).ready(function() {
                    var content = null;
                    $.ajax({
                        url: 'my_account/mailListSystem',
                        type: 'post',
                        data: {content:content},
                        dataType: 'text',
                        success: function( data ){
                            $('#ajax_respond_search_system').html( data );
                        }
                    });
                });
        ...
        if (!error) {
            $.ajax({
                ...
                success: function( jsonData ){
                    $('<div>').load('my_account/get_sent_mail/'+mail_id+'/', function() {
