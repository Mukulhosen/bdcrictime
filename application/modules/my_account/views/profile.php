...
<section class="content">    
    <?php echo Guest_Profile_helper::makeTab('#'); ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6 pull-right">
                            <button type="button" onclick="update_profile('my-account/profile/update');"  class="pull-right btn btn-success"><i class="fa fa-save"></i> Update</button>
                        </div>                                    
                    </div>
            </form>
        </div>
